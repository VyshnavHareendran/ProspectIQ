...
export default function AppearanceTab() {
  ...
  useEffect(() => {
      void Promise.resolve().then(loadAppearanceSettings);
  }, []);
  ...
  return (
    <Box>
      <SettingsHeader
        ...
        subtitle="Adjust workspace theme, density, language, and interface sizing."
      />

      <SettingsCard>
        <Stack spacing={3}>
          <FormControl>
            <FormLabel sx={{ mb: 1, fontWeight: 700 }}>Theme</FormLabel>
            <RadioGroup
              row
