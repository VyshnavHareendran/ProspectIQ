...
import { employeeProfileService } from "../../../../services/employeeSettings/profileService";
...
export default function AccountTab() {
        ...
        if (active) {
          setFormData({
            ...
            joined_date: profile.created_at
              ...
              : "N/A",
            last_login:
              profile.last_login || "Current session",
  ...
  const handlePhotoUpload = async (event) => {
    ...
    try {
      const response =
        await employeeProfileService.uploadProfilePhoto(file);
  ...
  const handlePhotoReset = async () => {
    try {
        const response =
        await employeeProfileService.resetProfilePhoto();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response =
        await employeeProfileService.updateProfile({
          full_name: fullName,
