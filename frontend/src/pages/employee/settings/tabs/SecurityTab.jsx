...
import { employeeSecurityService } from "../../../../services/employeeSettings/securityService";
...
export default function SecurityTab() {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      await employeeSecurityService.changePassword({
  ...
  useEffect(() => {
    const loadCurrentSession = async () => {
      try {
        const response =
            await employeeSecurityService.getCurrentSession();
